...
| M4 | Shared-VPS multi-user CEX pilot | Personal tenants, PostgreSQL RLS, passkeys, Vault Transit credentials, account preflight, tenant risk isolation, and a controlled `PILOT` cohort | Not started |
